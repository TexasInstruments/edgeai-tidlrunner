...
"""
HTML Generator V6 - Fuse JSON data into HTML template
...
Usage:
    python html_generator_v6.py <data.json> <template.html> <output.html>

Example:
    python html_generator_v6.py model_data.json.gz template_v6.html output.html
...
def load_json_data(json_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        expected_keys = ['model_data', 'subgraph_data', 'tidl_data', 'activation_data',
                        'metrics_data', 'config_data', 'proctime_data', 'cycles_data', 'memory_data']
...
def compress_activation_data(activation_data: Dict[str, Any]) -> str:
    ...
    V4 Enhancement: Reduces activation data size by 5-10x
    ...
    """
    print("\n[V4] Compressing activation data...")
...
def generate_html(json_data: Dict[str, Any], template_path: str, output_path: str):
    ...
    tidl_data = json_data.get('tidl_data', {})
    ...
    # Convert data to JSON strings (non-activation data stays uncompressed)
    ...
    # V4: Compress activation data
    activation_b64 = compress_activation_data(activation_data)

    # Wrap in JSON string for embedding
...
def main():
    ...
    print("=" * 70)
    print("HTML Generator V6 - Generating Visualization")
    print("=" * 70)
