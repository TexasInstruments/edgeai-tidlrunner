...
```
tidlrunner-cli <command> --config_path <configfile> [overrideoptions...]
```
...
To run inference:
```
tidlrunner-cli infer --config_path ./data/models/vision/classification/imagenet1k/torchvision/mobilenet_v2_tv_config.yaml
```
