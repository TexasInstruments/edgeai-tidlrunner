...
```
* Note: If the model simplification with onnxslim fails on a model, it can be disabled with the --simplify-model argument.
...
Use the help commands below to navigate understand the options supported with each commands.
