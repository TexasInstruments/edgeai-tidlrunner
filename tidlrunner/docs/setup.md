...
- This is automatically taken care of by [`set_proper_environment` in rtwrapper here](../edgeai_tidlrunner/rtwrapper/set_env.py). See how it is used in [`start_with_proper_environment` in start.py](../edgeai_tidlrunner/start.py), which is called from [cli.py](../edgeai_tidlrunner/cli.py)
