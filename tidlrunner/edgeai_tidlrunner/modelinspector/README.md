...
tidlrunner-cli inspect \
  --config_path data/configs/samples/models/vision/classification/imagenet1k/torchvision/mobilenet_v2_tv_config.yaml \
  --target_device AM62A
```
...
```bash
tidlrunner-cli inspect \
  --config_path data/configs/samples/models/vision/detection/coco/edgeai-mmdet/yolox_s_lite_640x640_20220221_model_config.yaml \
  --target_device AM62A
```
