...
* image_files_dataloader: Generic Image dataset from a folder - if accuracy computation is not needed, then this can be used (this does not provide any ground truth - so no accuracy will be computed when using this).
...
#### Generic Callable as Postprocess 
