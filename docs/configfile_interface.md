...
To run inference:
```
tidlrunner-cli infer_model --config_path ./data/models/configs.yaml
```
...
```
tidlrunner-cli compile_model --config_path ../edgeai-modelzoo/models/configs.yaml
```

To run inference:
```
tidlrunner-cli infer_model --config_path ../edgeai-modelzoo/models/configs.yaml
```
