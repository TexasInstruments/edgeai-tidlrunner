...
## What is new?
* 2026-July-29: r11.1.x branch is being released - with tidl_tools version updated to 11_02_17_00. For models compiled with this to work in SDK 11.1, this may need [firmware update](https://github.com/TexasInstruments/edgeai-tidl-tools/blob/master/scripts/setup/README.md) as described in [SDK Version Compatibility](https://github.com/TexasInstruments/edgeai-tidl-tools/blob/master/docs/sdk_version_compatibility_table.md). configs for models in edgeai-modelzoo has been added in [modelzoo configs](./data/configs/modelzoo/)
