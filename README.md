...
## Notice
* This repository is a work in progress and may have a few unexpected issues. Please report if you face any issues. We expect to release a more stable version by 2025 April.
* More details about TIDL and other tools are explained in [Edge AI developer landing page](https://github.com/TexasInstruments/edgeai) and [edgeai-tidl-tools](https://github.com/TexasInstruments/edgeai-tidl-tools) - highly recommend to read these.
