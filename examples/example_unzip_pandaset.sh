...
echo "Please download PandaSet Dataset first from https://pandaset.org/ or from https://huggingface.co/datasets/georghess/pandaset before running this script"
